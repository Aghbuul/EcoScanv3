...
def get_chatbot_response(user_message, context):
    try:
        ...
        context = [f"{m['text']}" for m in context]
        
        # Add chat history context (last 3 messages)
        chat_context = "\n".join(context[-3:]) if len(context) > 2 else ""
        ...
        1. Uses the available context to give more specific and relevant answers
        2. Includes specific, actionable steps when relevant
        3. Adds interesting environmental facts when appropriate
        4. Maintains a helpful and encouraging tone
        5. References detected items and previous advice when applicable
...
def main():
    ...
    if st.session_state.mode == 'simple':
        ...
        tab1, tab2 = st.tabs(["📸 Image Analysis", "💬 Chat with EcoBot"])
                ...
                if not uploaded_file:
                    st.markdown("""
                        <div class='uploadfile'>
                            <i class='material-icons' style='font-size: 48px; color: #2E7D32;'>cloud_upload</i>
                ...
                if items:
                    ...
                    with result_tab3:
                        ...
                        if model:
                            ...
                            specific_impact = impact_response.text.strip()
                        ...
                        """.format(specific_impact), unsafe_allow_html=True)
        ...
        with tab2:
            ...
            if user_message and not st.session_state.thinking:
                ...
                with st.spinner("EcoBot is thinking..."):
                    ...
                    context = "\n".join([
                        ...
                        for m in st.session_state.chat_history[-4:-1]
